...
function Dashboard (){
  ...
  const createTarget = (event) => {
    ...
    // For example, converting to upper case
      data.get('image_name');
      console.log("wTF dasdadad" + data.get('image_name'));
      axios({
          method: 'get',
    ...
    return (
      ...
      <br />
          <Container>
            <Button variant="primary" onClick={handleShow} className="float-end">Add</Button>
            <br />
            <br />
            {/* Add Modal  */}
